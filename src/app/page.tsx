const applicants = [
  ...
  ["Lisa Schmidt", "Haustier · vollstaendige Angaben", "64", "B"],
  ["Kevin Mueller", "Angaben unvollstaendig", "41", "C"],
];
      ...
      <section className="mx-auto max-w-7xl px-6 py-8">
        <nav className="flex items-center justify-between border-b border-white/10 pb-6">
          ...
          <div className="flex gap-3">
            <a href="#produkt" className="rounded-full border border-white/10 px-5 py-3 text-sm font-black uppercase">
              Produkt
            </a>
            <a href="#demo" className="rounded-full bg-emerald-400 px-5 py-3 text-sm font-black uppercase text-black">
              Demo anfragen
            </a>
          </div>
        </nav>
        ...
        <section className="grid min-h-[78vh] items-center gap-12 py-14 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-8 max-w-2xl text-xl leading-9 text-zinc-300">
              ...
              welche Interessenten zuerst geprueft werden sollten.
            </p>

            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a href="#demo" className="rounded-xl bg-emerald-400 px-9 py-5 text-center font-black uppercase text-black">
                Demo anfragen
              </a>
              <a href="#produkt" className="rounded-xl border border-white/10 px-9 py-5 text-center font-black uppercase">
                Dashboard ansehen
              </a>
            </div>
          </div>

          <div id="produkt" className="rounded-[34px] border border-white/10 bg-[#0b0b0d] p-6 shadow-[0_0_100px_rgba(16,185,129,0.14)]">
            ...
            <div className="mt-6 overflow-hidden rounded-2xl border border-white/10">
              {applicants.map(([name, meta, score, type]) => (
                <div key={name} className="flex items-center justify-between border-b border-white/10 px-5 py-4 last:border-b-0">
                  <div>
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <span className={type === "A" ? "text-2xl font-black text-emerald-400" : type === "C" ? "text-2xl font-black text-red-400" : "text-2xl font-black"}>
                      {type}
                    </span>
                  </div>
                </div>
